...
class BookQuestions {
    ...
    init() {
        ...
        let orginizedQuestions = orginizeQuestions(decodedQuestions)
        populateBooks(with: orginizedQuestions)
    }
    ...
    private func orginizeQuestions(_ questions: [Question]) -> [[Question]] {
        var orginizeQuestions: [[Question]] = [[], [], [], [], [], [], [], [],]
        
        for question in questions {
            orginizeQuestions[question.book].append(question)
        }
        
        return orginizeQuestions
    }
